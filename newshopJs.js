function validation(frm,product,price){
    ...
    if(sample){
        ...
        document.getElementById("products_details").innerHTML += "Quantity:" + amount + "<br>";
...
function placeOrder(){
    ...
    if(f_name.length == 0){
        alert("Pleasse enter your First name: ");
        submit=false;
    }
    
    if(email.length == 0){
        alert("Pleasse enter your Email: ");
        submit=false;
    }
    
    if(address.length == 0){
        alert("Pleasse enter your Address ");
        submit=false;
    }
    
    if(l_name.length == 0){
        alert("Pleasse enter your Last name: ");
        submit=false;
    }
